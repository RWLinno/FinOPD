...
\footnotesize
\caption{Overall portfolio-level results on Dow-30 (25 assets, 2025 test). Mean $\pm$ std over 3 seeds. ${\sim}$ denotes projected values pending full-scale run.}
...
\midrule
\textsc{FinOPD} (Ours) & 2.5 & 0.82 & 2.6 & 0.96 & 1.05 & 53.5 \\
\bottomrule
\end{tabular}
\label{tab:overall}
\end{table}
